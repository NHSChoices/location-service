...
using System.Web;
using Configuration = Devbridge.BasicAuthentication.Configuration;
...
//namespace Devbridge.BasicAuthentication
{
    ...
    public class BasicAuthenticationModule : IHttpModule
    {
        ...
        /// </summary>
        public const string Realm = "api.nhs.uk";
        ...
        /// </summary>
        private readonly static IDictionary<string, bool> ShouldChallengeCache = new Dictionary<string, bool>();
        ...
        private void IssueAuthenticationChallenge(Object source, EventArgs e)
        {
            var context = ((HttpApplication)source).Context;

            if (IsStatusOK(context.Response.StatusCode) || (allowRedirects && IsRedirect(context.Response.StatusCode)))
            {
                return;
            }
        ...
        private static bool IsStatusOK(int httpStatusCode)
        {
            return new[]
            {
                HttpStatusCode.OK
        ...
        {
            activeUsers = new Dictionary<string, string> {{username, password}};
        }
